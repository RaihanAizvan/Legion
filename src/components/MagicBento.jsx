...
const DEFAULT_GLOW_COLOR = '34, 211, 238'; // Cyan color
...
const BentoCardGrid = ({ children, gridRef }) => (
    <div
        className="bento-section grid gap-4 p-4 w-full h-full select-none relative z-10"
        ref={gridRef}
    >
        {children}
    </div>
    ...
    return (
        <div className="w-full relative">
          ...
          .bento-section {
            ...
            --background-dark: rgba(25, 25, 30, 0.4);
            --white: hsl(0, 0%, 100%);
          }
        ...
        `}
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid gap-4 lg:gap-6">
                    {items.map((card, index) => {
                        const baseClassName = `card flex flex-col justify-between relative min-h-[220px] w-full max-w-full p-6 md:p-8 rounded-[24px] border border-white/5 font-light overflow-hidden transition-all duration-300 ease-in-out backdrop-blur-xl ${enableBorderGlow ? 'card--border-glow' : ''
                            }`;

                        const cardStyle = {
                            backgroundColor: card.color || 'var(--background-dark)', // using passed custom colors
                            ...
                            <>
                                ...
                                {card.image && (
                                    <div className="absolute inset-0 z-0 pointer-events-none">
                                        <img src={card.image} alt={card.title} className="w-full h-full object-cover opacity-50 mix-blend-screen" />
